...
public class UserController {
    ...
    public User signup(@RequestBody User user){
    	...
    	return userRepository.save(user);
			...
			/*
			 * @PostMapping("na/forgot") public User forgotPassword(@RequestBody User user){
			 * 
			 * return userService.findByEmailAndSecQuestionAndSecAnswer(user.getEmail(),
			 * user.getSecQuestion(),user.getSecAnswer()); }
			 */ 
